...
public class AndroidAdapter extends RecyclerView.Adapter<ViewHolder> {
    int a;
    public AndroidAdapter(int a){
        this.a = a;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        parseQuery.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                ...
                if (objects.size() > 0 && e == null) {
                    ...
                    holder.edtViewDes.setText(objects.get(position).get("image_des")+"");
        ...
        holder.edtViewUser.setText(ParseUser.getCurrentUser().getUsername());
